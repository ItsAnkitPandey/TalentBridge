      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <ul>
            ...
            <li>Type: ${requester.user_type}</li>
            ${requester.phone ? `<li>Phone: ${requester.phone}</li>` : ''}
          </ul>
...
const sendReferralAcceptedEmail = async (requester, referrer, job) => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p><strong>${referrer.first_name} ${referrer.last_name}</strong> has agreed to provide a referral for:</p>
          ...
          <ol>
            ...
            <li>Follow up with ${referrer.first_name} if needed</li>
  ...
  return sendEmail({
    ...
    html,
    text: `Hi ${requester.first_name}, Good news! ${referrer.first_name} ${referrer.last_name} has accepted your referral request for ${job.title}. View details at ${config.frontendUrl}/my-referrals`
  });
};
...
const sendNewJobNotification = async (user, job) => {
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="job-card">
            ...
            <p><strong>Type:</strong> ${job.job_type} - ${job.remote_type}</p>
          </div>
  ...
  return sendEmail({
    to: user.email,
    subject: `New Job: ${job.title} at ${job.Organization?.name || 'Company'}`,
    html,
    text: `Hi ${user.first_name}, Check out this new job: ${job.title} at ${job.Organization?.name}. View at ${config.frontendUrl}/jobs/${job.id}`
  });
};
...
const sendJobApprovalNotification = async (job, poster, adminEmails) => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="job-card">
            <h2 style="margin-top: 0; color: #1976d2;">${job.title}</h2>
            ...
            <div style="margin-top: 20px;">
              ...
              <div class="info-row">
                <span class="info-label">Experience Level:</span> ${job.experience_level}
              </div>
              <div class="info-row">
                <span class="info-label">Remote Type:</span> ${job.remote_type}
              </div>
            </div>

            <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #eee;">
              <div class="info-row">
                <span class="info-label">Posted By:</span> ${poster.first_name} ${poster.last_name} (${poster.email})
              </div>
              <div class="info-row">
          ...
          <div style="background: #e3f2fd; padding: 15px; border-radius: 5px; margin: 20px 0;">
            ...
            <p style="margin: 10px 0; color: #666;">
              ${job.description ? job.description.substring(0, 200) + '...' : 'No description provided'}
            </p>
          </div>
  ...
  const emailPromises = adminEmails.map(adminEmail => 
    sendEmail({
      ...
      html,
      text: `New job pending approval: ${job.title} at ${job.organization?.name || 'N/A'}. Posted by ${poster.first_name} ${poster.last_name}. Review at ${adminUrl}`
    })
  );
