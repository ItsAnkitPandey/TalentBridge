        ...
        <Container maxWidth="md" sx={{ position: 'relative', zIndex: 1 }}>
          ...
          >
            <Typography variant="h5" paragraph>
              Connect with employees, get referrals, and land your dream job
            </Typography>
          </motion.div>
          <motion.div
...
{[
          ...
          >
    ...
    </motion.div <Grid container spacing={4} textAlign="center">
            ...
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 3 }}>
                ...
                <Typography variant="h6">Referrers</Typography>
              </Paper>
            </Grid>
            <Grid item xs={12} md={4}>
              <Paper sx={{ p: 3 }}>
